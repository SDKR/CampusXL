/* use toggle function to show / hide menu */
function ShowMenu() {
...
function ShowKategori1() {
    var x = document.getElementById("Kategori1");
...
function ShowSlideShow1() {
	var x = document.getElementById('Slideshow1');
    if (x.style.display === "none") {
	...
	console.log(getRotationDegrees($(".arrow")));	
	var Degrees = getRotationDegrees($(".arrow"))
	if (Degrees == 315) 
	{
...
$(".top-info").on("click", () => {ShowSlideShow1()});
